...
@interface TestViewController_5 ()
@property (nonatomic,strong) UIButton *btn;
@end

@implementation TestViewController_5
...
- (void)btnAction{
    // backStr 是父视图的属性
    [DLRouter pop:@{@"backStr":@"Hi,我是从 TestViewController_5 回调的参数"} animated:YES];
}
