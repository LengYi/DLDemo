...
}), ("undefined" != typeof window.AudioContext || "undefined" != typeof window.webkitAudioContext || -1 == navigator.userAgent.indexOf("Android")) && (allowSound = !0, sound = new Howl({urls: ["audio/sound.mp3", "audio/sound.m4a"],sprite: {pop1: [0, 400],pop2: [500, 400],pop3: [1e3, 750],click: [2e3, 300],timesUp: [2500, 2400],explode: [5e3, 1500],drag: [7e3, 400]}}), music = new Howl({urls: ["audio/music.mp3", "audio/music.m4a"],volume: .25,loop: !0}));
